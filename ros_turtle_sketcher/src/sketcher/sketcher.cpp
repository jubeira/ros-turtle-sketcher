...
void moveToGoal(turtlesim::Pose& goal_pose, double dist_tol)
{
    ...
    do {
        ...
        cout << "Target angle: " << target_angle << " current angle: " << m2d::normalizeAngle(turtlesim_pose.theta) << endl;
...
void aimAndMove(turtlesim::Pose& goal_pose, double dist_tol, double line_straightness_tol)
{
    ...
    cout << "Real normalized angle: " << m2d::normalizeAngle(turtlesim_pose.theta) << endl;
